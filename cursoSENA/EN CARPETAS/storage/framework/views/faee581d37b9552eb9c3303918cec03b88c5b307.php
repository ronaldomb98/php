...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(asset('css/lib/ionicons/ionicons.min.css')); ?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(asset('css/lib/admin_lte/adminlte.min.css')); ?>">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect. -->
  <link rel="stylesheet" href="<?php echo e(asset('css/lib/admin_lte/skins/skin-blue.min.css')); ?>">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(route('logout')); ?>"  class="btn btn-default btn-flat" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Salir</a>
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset('js/lib/adminlte.min.js')); ?>"></script>
<!-- Bootbox -->
<script src="<?php echo e(asset('js/lib/bootbox/bootbox.min.js')); ?>"></script>
